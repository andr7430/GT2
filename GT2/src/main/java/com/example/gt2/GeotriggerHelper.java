...
public final class GeotriggerHelper {
     ...
     * {@link android.app.Activity#onStart} method of an {@link android.app.Activity} that uses the Geotrigger location services.
     *
     * @param activity The {@link android.app.Activity} that is currently displayed.
     * @param requestCode A request that may be returned in {@link android.app.Activity#onActivityResult}
     *                    if overridden in the provided {@link android.app.Activity}
